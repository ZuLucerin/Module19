...
def test_add_new_pet_with_valid_data(name ='Блек', animal_type ='дворняга',
                                     age ='4', pet_photo ='image/hqdefault.jpg'):
...
def test_add_new_create_pet_simple_with_valid_data(name ='Барс', animal_type ='шотландский',
                                     age ='6'):
...
def test_add_new_pets_set_photo_pet_id_with_valid_data(pet_photo = 'image/P1040103.jpg'):
...
def test_add_new_pet(name ='//////', animal_type ='******',
                                     age ='Four', pet_photo ='image/cat1.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Супчик", "кот", "35", "image/cat1.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
